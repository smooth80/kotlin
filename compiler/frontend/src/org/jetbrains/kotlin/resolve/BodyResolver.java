...
public class BodyResolver {
    ...
    public void resolveSecondaryConstructorBody(
        ...
        resolveFunctionBody(
                ...
                scope -> new LexicalScopeImpl(
                        scope, descriptor, scope.isOwnerDescriptorAccessibleByLabel(), scope.getImplicitReceiver(), scope.getContextReceiversGroup(),                        LexicalScopeKind.CONSTRUCTOR_HEADER
                ),
                localContext
        );
    }
    ...
    private void checkRedeclarationsInClassHeaderWithoutPrimaryConstructor(
        ...
        new LexicalScopeImpl(
                scopeForConstructorResolution, descriptor, true, null, Collections.emptyList(),
    ...
    private static LexicalScope makeScopeForPropertyAccessor(
        ...
        return new LexicalScopeImpl(headerScope, descriptor, true, descriptor.getExtensionReceiverParameter(), /*TODO*/ Collections.emptyList(),
