...
private fun excludeStdlibCommonFromJvmCompilationsAndSourceSets(project: Project) {
    ...
    val jvmTargets = multiplatformExtension.targets.withType(KotlinJvmTarget::class.java).all { jvmTarget ->
        ...
        configurationsNamesToExcludeStdlibFrom.forEach {
            project.configurations.getByName(it).exclude(mapOf("group" to "org.jetbrains.kotlin", "module" to "kotlin-stdlib-common"))
        }
    }
    println(jvmTargets)
}
